...
const ZH_HANS_COLORS = [
	'赤色的', '橙色的', '黄色的', '绿色的', '青色的', '蓝色的', '紫色的', '金色的',
	'银色的', '白色的', '灰色的', '黑色的', '粉色的', '棕色的', '琥珀色的', '翠绿色的',
	'天蓝色的', '藏青色的', '绛红色的', '米色的', '墨色的', '茶色的', '朱红色的', '碧色的'
];
const ZH_HANS_ANIMALS = [
	'海豹', '水獭', '海豚', '兔子', '狼', '水豚', '乌龟', '狐狸', '鲸鱼', '熊', '考拉', '鹿',
	'麻雀', '狸猫', '燕子', '仙鹤', '蜥蜴', '天鹅', '游隼', '熊猫', '猫头鹰', '企鹅', '萤火虫',
	'松鼠', '老鹰', '小猫', '刺猬'
];
const ZH_HANT_COLORS = [
	'赤色的', '橙色的', '黃色的', '綠色的', '青色的', '藍色的', '紫色的', '金色的',
	'銀色的', '白色的', '灰色的', '黑色的', '粉色的', '棕色的', '琥珀色的', '翠綠色的',
	'天藍色的', '藏青色的', '絳紅色的', '米色的', '墨色的', '茶色的', '朱紅色的', '碧色的'
];
const ZH_HANT_ANIMALS = [
	'海豹', '水獺', '海豚', '兔子', '狼', '水豚', '烏龜', '狐狸', '鯨魚', '熊', '無尾熊', '鹿',
	'麻雀', '狸貓', '燕子', '仙鶴', '蜥蜴', '天鵝', '遊隼', '熊貓', '貓頭鷹', '企鵝', '螢火蟲',
	'松鼠', '老鷹', '小貓', '刺蝟'
];
/** Adnominal forms (`〜색`), read as "<colour> <animal>". */
const KO_COLORS = [
	'빨간', '주황', '노란', '초록', '파란', '남색', '보라', '금색', '은색', '하얀', '회색',
	'검은', '분홍', '갈색', '호박색', '하늘색', '자주색', '연두', '옥색', '먹색', '살구색', '청록'
];
const KO_ANIMALS = [
	'물개', '수달', '돌고래', '토끼', '늑대', '카피바라', '거북이', '여우', '고래', '곰', '코알라',
	'사슴', '참새', '너구리', '제비', '두루미', '도마뱀', '백조', '매', '판다', '부엉이', '펭귄',
	'반딧불이', '다람쥐', '독수리', '고양이', '고슴도치'
];
