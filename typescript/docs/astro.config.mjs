...
export default defineConfig({
  integrations: [
    starlight({
      title: "Proxy Guru",
      description:
        "A managed TCP/TLS proxy fabric: design a topology, ship one config per server.",
      defaultLocale: "root",
      locales: {
      ...
      editLink: {
        baseUrl:
          "https://github.com/haruki-nikaidou/proxy-guru/edit/main/typescript/docs/",
      },
      social: [
        {
          icon: "github",
        ...
        starlightThemeBlack({
          navLinks: [
            ...
            },
            {
              ...
              translations: navLinkTranslations(
                "Reference",
                "リファレンス",
                "参考",
              ),
